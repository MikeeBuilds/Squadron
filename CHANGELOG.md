...
## [0.4.0] - 2025-12-10
### Added
- **Discord Bot**: Full `discord.py` integration.
    - `squadron listen --discord`: Starts a persistent bot connection.
    - Supports receiving messages and replying as specific agents via Webhook masquerading.
    - Requires `DISCORD_BOT_TOKEN` and `MESSAGE CONTENT INTENT`.
