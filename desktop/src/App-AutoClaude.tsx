...
import {
  ...
  DialogHeader,
  DialogTitle
} from './components/auto-claude/ui/dialog';
import {
  Tooltip,
  TooltipContent,
  TooltipTrigger
...
import { AppSettingsDialog, type AppSection } from './components/auto-claude/settings/AppSettings';
import type { ProjectSettingsSection } from './components/auto-claude/settings/ProjectSettingsContent';
...
import { RateLimitModal } from './components/auto-claude/RateLimitModal';
import { SDKRateLimitModal } from './components/auto-claude/SDKRateLimitModal';
import { OnboardingWizard } from './components/auto-claude/onboarding';
import { AppUpdateNotification } from './components/auto-claude/AppUpdateNotification';

import { ProactiveSwapListener } from './components/auto-claude/ProactiveSwapListener';
import { GitHubSetupModal } from './components/auto-claude/GitHubSetupModal';
import { useProjectStore, loadProjects, addProject, initializeProject } from './stores/auto-claude/project-store';
...
import { useTerminalStore, restoreTerminalSessions } from './stores/auto-claude/terminal-store';
import { useIpcListeners } from './components/auto-claude/hooks/useIpc';
