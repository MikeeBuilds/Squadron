...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden w-[var(--sidebar-width)] transition-[width] duration-200 ease-linear data-[state=collapsed]:w-[var(--sidebar-width-icon)] text-sidebar-foreground md:block"
        data-state={state}
