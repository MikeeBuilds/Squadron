...
export default function App() {
  ...
  return (
    <SidebarProvider>
      <div className="flex h-screen w-full bg-zinc-100 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-sans overflow-hidden">
        <Sidebar collapsible="icon" className="border-zinc-800 bg-zinc-950/50 backdrop-blur-xl">
        ...
        <SidebarInset className="bg-zinc-950 border-none overflow-hidden">
          <main className="flex-1 overflow-auto p-8 sm:p-12 relative flex flex-col items-center custom-scrollbar">
